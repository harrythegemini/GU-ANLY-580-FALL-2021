...
The purpose of this exam is self study, and to familiarize you with some of the underlying concepts used in machine learning and NLP. Feel free to use definitions from Wikipedia to aid in this self study, but refrain from searching for answers directly. If you get stuck, team up with no more than three classmates and work together. If you work in teams, please list your teammates on your exam.

To submit this test, either enter your answers directly in the `exams/placement-exam.md` using markdown syntax, or upload a separate file containing your solutions, for example `exams/placement-exam-solutions.pdf`.
